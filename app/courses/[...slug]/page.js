    ...
    (async () => {
      ...
      if (count == 2) {
        const courses = params.slug[0]
          ...
          .replaceAll("%26", "&");
        setCategory(courses);
        let list = await getlist(courses);
        setlist(list.courses);
        const decodedTitle = params.slug[1]
          .replaceAll("%20", " ")
          .replaceAll("%2B", "+");
        let title = decodedTitle.split(" ")[0];
        // console.log(list);
        setcourse(title);
        try {
          const Data = await getcourseDetails(decodedTitle);
          // console.log(Data);
          setdata(Data);
        } catch (error) {
          console.log(error);
                    ...
                    return (
                      ...
                      >
                        <div className="bg-gray-100 text-black rounded flex p-4 h-full items-center">
                          <Image src={item.img} height={30} width={30} />
                    ...
                    <div className="w-full mx-auto">
                      ...
                      <div className="content py-5 lg:px-2">
                                  ...
                                  <div className="flex rounded-lg h-full bg-gray-100 lg:p-8 p-4 py-6 flex-col">
                                    ...
                                    <div className="flex-grow">
                                      <div className="leading-relaxed text-lg">
                                        ...
                                        is provided to college Students,
                                        Freshers who have passed out as wells as
                                        working candidates
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div className="flex rounded-lg h-full bg-gray-100 lg:p-8 p-4 py-6 flex-col">
                                    ...
                                    <div className="flex-grow">
                                      <div className="leading-relaxed text-lg">
                                        ...
                                        <p>
                                          3rd Month will be totall baised on
                                          Project building,
                                        </p>
                                      </div>
                                    </div>
                                  ...
                                  <div className="flex rounded-lg h-full bg-gray-100 lg:p-8 p-4 py-6 flex-col">
                                    ...
                                    <div className="flex-grow">
                                      <div className="leading-relaxed text-lg">
                                        <p>24/7 support</p>
                                        <p>
                                          We are having 24/7 Support team to
                                          clear students’ needs and doubts.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                        ...
                        <div className="button flex justify-center">
                          <button className="lg:w-1/3 w-[80%] text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
                            Buy Course
                          </button>
                        </div>
                      </div>
