  ...
  const data = [
    {
      ...
      role: "Lead Developer",
      instagram:
        "https://www.instagram.com/shubham_bhilare_3611?igsh=MWl6MTdlOG5tdXB6MQ==",
      github: "https://github.com/Skb3611",
      linkden:
        "https://www.linkedin.com/in/shubham-bhilare-0a694a309?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    ...
    },
    {
      ...
      role: "Web Developer",
      instagram:
        "https://www.instagram.com/_omkar__d_07?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
      facebook: "",
      linkden: "",
    },
    {
      ...
      role: "Web Designer",
      instagram:
        "https://www.instagram.com/imperial_aayush07?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
      facebook: "",
      linkden: "",
    },
    {
      ...
      role: "Web Designer",
      instagram:
        "https://www.instagram.com/sainath_0036?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
      facebook: "",
      linkden: "",
    },
  ];
      ...
      <div className="flex items-center justify-center  my-12 md:my-20 flex-wrap flex-shrink gap-5">
        {data.map((item) => {
          return (
            <div
              key={Math.random()}
              className="w-3/4 sm:w-72 rounded-lg overflow-hidden ring-1 shadow-lg p-6 bg-white hover:scale-105 transition-all duration-500"
            >
