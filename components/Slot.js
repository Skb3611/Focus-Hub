    ...
    return (
        <div className='relative overflow-hidden' id='slot'>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-4 py-8 lg:py-24 mx-auto w-full md:w-[90%]">
                    <div className="flex flex-col justify-center items-center w-full mb-5 lg:mb-20">
                        <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
                            <div className="sm:text-3xl lg:text-4xl text-xl font-medium title-font -mb-2 lg:mb-2 text-gray-900 text-center">
                                <TypeAnimation
                                    sequence={[
                                        // Same substring at the start will only be typed out once, initially
                                        'Book Your Session In Focus Hub',
                                        1000, 
                                        '',
                                        500
                    ...
                    <div className="flex flex-wrap justify-center  w-full">
                        {data.map((item) => {
                            return (
                                <Link href={"/enquiry"} onClick={handleclick} key={item.title} className="px-2 w-full sm:w-1/2 lg:1/3 xl:w-1/4 cursor-pointer hover:scale-105 transition-all duration-500">
                                    <div className="flex flex-wrap w-full bg-gray-800 sm:py-24 py-16 sm:px-10 px-6 relative h-[90%] rounded-lg">
                                        <img alt="gallery" className="w-full object-fill h-full object-center block opacity-35 absolute inset-0" src={item.imageURL} />
